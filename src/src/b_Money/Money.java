...
public class Money implements Comparable {
	...
	public Integer universalValue() {
		return (int) (getAmount() * getCurrency().getRate() * 100);
	}
	...
	public Money add(Money other) {
		return new Money(
				this.amount + this.currency.valueInThisCurrency(other.amount, other.currency),
				this.getCurrency()
		);
	}
	...
	public Boolean isZero() {
		return Objects.equals(this.amount, 0);
	}
	/**
